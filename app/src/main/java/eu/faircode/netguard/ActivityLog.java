...
public class ActivityLog extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvLog.setAdapter(adapter);
         ...
         //------- Stats and more functionality by Louis Gröfke----------//

        btnToLogs = findViewById(R.id.btnToLogs);

        btnToLogs.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ActivityLog.this, ActivityStats.class));
